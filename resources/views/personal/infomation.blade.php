            ...
            <div class="row p-0">
                <div class="col-lg-6">
                    <div class="box-information-input">
                        ...
                        <input id="input-username" class="information-input readonly" name="TenDangNhap" type="text"
                    ...
                    <div class="box-information-input">
                        ...
                        <input id="input-full-name" class="information-input readonly" type="text" name="HoVaTen"
                    ...
                    <div class="box-information-input">
                        ...
                        <input id="input-phone-number" maxlength="10" class="information-input readonly" type="text"
                            name="SDT" placeholder="Số điện thoại" maxlength="10">
                ...
                <div class="col-lg-6">
                    <div class="box-information-input">
                        ...
                        <input id="input-date-of-birth" class="information-input" type="date" name="NgaySinh"
                    ...
                    <div class="box-information-input">
                        ...
                        <div class="information-input information-input-don-hover">
                            ...
                            <button class="btn-update-password" data-bs-toggle="modal"
                                data-bs-target="#modal-change-password">Đổi mật khẩu</button>
                        </div>
                    </div>
                    <div class="box-information-input">
                    ...
                    <div class="modal-body" style="height: 350px;">
                        <div class="box-information-input">
                            ...
                            <input id="input-old-password" maxlength="10" class="information-input password"
                                type="password" name="old_password" placeholder="Mật khẩu cũ">
                        ...
                        <div class="box-information-input">
                            ...
                            <input id="input-new-password" maxlength="10" class="information-input password"
                                type="password" name="new_password" placeholder="Mật khẩu mới">
                            <span class="error-information" id="error-input-new-password"></span>
                        </div>
                        <div class="box-information-input">
                            <label for="input-new-password-confirmation" class="information-label">Nhập lại mật khẩu
                                mới</label>
                            <input id="input-new-password-confirmation" maxlength="10" class="information-input password"
                                type="password" name="new_password_confirmation" placeholder="Nhập lại mật khẩu mới">
