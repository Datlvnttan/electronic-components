                        ...
                        <div class="p-lg-4 row">
                            <div class="col-lg-6 col-12">
                                <div class="box-input-update">
                                    ...
                                    <input class="input-update" type="text" name="MaNCC" id="MaNCC"
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="box-input-update">
                                    <label class="label-input-update" for="TenNCC">Tên nhà cung cấp<span
                                            class="required-field">*</span></label>
                                    <input class="input-update" type="text" name="TenNCC" id="TenNCC"
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="box-input-update">
                                    <label class="label-input-update" for="DiaChi">Địa chỉ<span
                                            class="required-field">*</span></label>
                                    <input class="input-update" type="text" name="DiaChi" id="DiaChi"
                                        placeholder="Địa chỉ">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="box-input-update">
                                    <label class="label-input-update" for="SDT">Số điện thoại<span
                                            class="required-field">*</span></label>
                                    <input class="input-update" type="text" name="SDT" id="SDT"
